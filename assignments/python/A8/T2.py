# Type 2 - without parameters, with return type
...
rect_area = rectangle_area()
print("1. Area of the rectangle =",rect_area)

cir_area = circle_area()
...
print("6. Fibonacci series cannot work in Type 2!")
